...
/**
 * Proxy for FanHub "ICS Preview — TeamSnap" (Setup Wizard — Step 2).
 *
 ...
 * TeamSnap calendar feed was fetched and parsed successfully.
 */
export async function POST(request: Request) {
  ...
  try {
    ...
    const upstream = await fetch(`${config.apiUrl}/${routes.api.icsTeamSnap}`, {
      method: "POST",
      headers: {
